package com.aluno.app.controller;
...
import com.aluno.app.repository.AlunoRepository;
...
public class AlunoController {
	...
	public ModelAndView alterar(@PathVariable("id_aluno") Long id_aluno) {
	...
	public ModelAndView excluir(@PathVariable("id_aluno") Long id_aluno) {
